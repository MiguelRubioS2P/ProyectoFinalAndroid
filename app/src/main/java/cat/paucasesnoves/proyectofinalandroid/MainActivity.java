...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            JSONObject conexion = new JSONObject(Auxiliar.interacionPost(pref.getUser(), pref.getPassword(),
                    true));
            ...
            public void run() {
                try {
                    new Recepcio(MainActivity.this, lv, pref,
                            dbQuePasaAux.isEmpty()).execute(); //Descarrega els missatges els guardadins la
